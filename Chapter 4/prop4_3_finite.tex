...
\begin{proof}
  % FAKE REF: "Lemma~4.4" -> replace by \ref{lem:monotone}
  %   target: monotone sandwich lemma (ch4_structure.md, Lemma 4.4 / tools in §4.3;
  %   same statement as lem:monotone in extension_of_approximation_on_general.tex).
  By monotonicity of $(\pi_M)$ (Lemma~4.4) it suffices to
